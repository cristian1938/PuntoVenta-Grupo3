...
namespace Proyecto_Metodologia
{
    public partial class FrmSistemaVentas : Form
    {
        ...
        private void AbrirFormularioHijo2()
        {

            FrmArqueo FrmHijo = new FrmArqueo();
            FrmHijo.TopLevel = false;
            FrmHijo.FormBorderStyle = FormBorderStyle.None;
            FrmHijo.Dock = DockStyle.Fill;
            FrmHijo.USUARIO = txtheadtext.Text;
            FrmHijo.CATEGORIA = txtcategoria.Text;
            panelcontenido.Controls.Add(FrmHijo);
            panelcontenido.Tag = FrmHijo;
            FrmHijo.BringToFront();
            FrmHijo.Show();
